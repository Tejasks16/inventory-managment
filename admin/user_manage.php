<?php
	...
	if(isset($_POST['addUserToken']))
	{
		...
		if($_POST['addUserToken']===$token)
		{
			...
			{
				$query = "INSERT INTO user (userEmail, userPassword, userName, userType, userStatus,userRole)
						VALUES (:userEmail, :userPassword, :userName, :userType, :userStatus, :userRole)";
